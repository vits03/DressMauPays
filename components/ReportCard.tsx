...
/>
        ...
        <div className="card-details space-y-2 px-3">
          <h2 className="card-title text-lg font-medium text-gray-900 text-ellipsis line-clamp-1 my-1">{  title[0].toUpperCase()+title.substring(1)}</h2>
